...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
        String sql="select DoctorID as [Doctor ID], DoctorName as [Doctor Name],FatherName as [Father's Name],Address,ContactNo as [Contact No],Email as [Email ID],Qualifications,Specialization,Gender,BloodGroup as [Blood Group],DateOfJoining as [Joining Date] from Doctor order by DoctorName";
          try{

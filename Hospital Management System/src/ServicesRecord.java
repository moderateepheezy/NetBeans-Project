...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
       String sql="select ServiceID as [Service ID], ServiceName as [Service Name],ServiceDate as [Service Date],PatientRegistration.PatientID as [Patient ID],PatientName as [Patient Name],ServiceCharges as [Service Charges] from PatientRegistration,Services where Services.PatientID=PatientRegistration.PatientID order by PatientName"; try{

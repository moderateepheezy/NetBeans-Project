...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
        String sql="select PatientID as [Patient ID], PatientName as [Patient Name],FatherName as [Father's Name],Address,ContactNo as [Contact No],Email as [Email ID],Age,Gen as [Gender],BG as [Blood Group],Remarks from Patientregistration";
          try{
